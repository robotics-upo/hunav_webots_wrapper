...
def generate_launch_description():
    ...
    # base world file path
    base_world_file_path = PathJoinSubstitution([
        FindPackageShare('hunav_webots_wrapper'),
        'worlds',
        world_file_name
    ])
    ...
    ordered_launch_event = RegisterEventHandler(
        OnProcessStart(
            ...
            on_start=[
                LogInfo(msg='HunNavLoader started, launching HuNav_webots_world_generator after 2 seconds...'),
                TimerAction(
                    period=2.0,
    ...
    declare_agents_conf_file = DeclareLaunchArgument(
        'configuration_file', default_value='agents_factory.yaml',
